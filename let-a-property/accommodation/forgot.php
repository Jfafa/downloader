<html>
<head>
<META HTTP-EQUIV="PRAGMA" CONTENT="NO-CACHE"><meta http-equiv=Content-Language content=en-gb><META NAME=ROBOTS CONTENT="NOARCHIVE, NOINDEX, NOFOLLOW"><TITLE>Password Retrieval</TITLE><META NAME=Title CONTENT="Password Retrieval"><META NAME=description CONTENT="Password Retrieval"><META NAME=keywords CONTENT=", , , , , , , , , "><META NAME=document-rating CONTENT=General><META NAME=document-distribution CONTENT=Global>
...
<div class=breadcrumb><a href="../index.htm">Homepage</a><font color="#FF0000" size="1"> &gt;</font> <a href="advertise.php"> Free Property Advertising</a><font color="#FF0000" size="1"> &gt;</font> <a href="login.php">Login</a><font color="#FF0000" size="1"> &gt;</font> Password Retrieval<font color="#FF0000" size="1"> &gt;</font></div><div class=pagetitle><h1>Password Retrieval</h1></div><div class=mainbody>

<table bgcolor="#FFFFFF" border="1" bordercolor="#FFFFFF" style="border-collapse: collapse" cellpadding="0" cellspacing="0">
        <tr>
        <center>
<td>
      </span>
  
      <p align="justify" style="word-spacing: 0; margin: 0"><font size="2">
      Please enter your registered email to retrieve your password. Please 
      remember to check your 'anti-spam' email folder, in case your PC anti spam 
      software accidentally classified it as 'spam' email.&nbsp; </font></p>
...
<p align="center" style="word-spacing: 0; margin: 0">&nbsp;</p>
        ...
        <form id="frmLogin" name="frmLogin" action="_scripts/forgot_pwd.php" method="post">
	<p align="center"><font face="Tahoma"><b><font size="2">'Spam Prevention' Code:</font></b><font size="2"><img id="captcha" src="../securimage/securimage_show.php" alt="CAPTCHA Image" /></font></p>
	 <p align="center" style="word-spacing: 0; margin: 0"></font><b>
     <font size="2" face="Tahoma">&nbsp;&nbsp;</font></b><p align="center" style="word-spacing: 0; margin: 0"><b>
     <font size="2" face="Tahoma">Please Enter the Code Shown above:</font></b><p align="center" style="word-spacing: 0; margin: 0"><b>
     <font face="Tahoma">
	 <br />
	<input type="text" name="captcha_code" size="10" maxlength="6" />
	<a href="#" onclick="document.getElementById('captcha').src = '/securimage/securimage_show.php?' + Math.random(); return false">[ Different Image ]</a></font></b><p align="center" style="word-spacing: 0; margin: 0"><b><p>
      <p align="center" style="word-spacing: 0; margin: 0">&nbsp;</p>
      <p align="center" style="word-spacing: 0; margin: 0">
      <font size="2" face="Tahoma">Email:</font></p>
      <p align="center" style="word-spacing: 0; margin: 0"><font face="Tahoma">&nbsp;<input type="text" name="txtEmailAddress" id="txtEmailAddress" size="30" style="font-family: Tahoma; color: #0066CC; font-size: 10pt; background-color: #DDDDDD"></font></p>
<p align="center" style="word-spacing: 0; margin: 0">&nbsp;</p>
<p align="center" style="word-spacing: 0; margin: 0">
 
 <font face="Tahoma">
<input type="submit" value="Send my Password" style="font-family: Tahoma; color: #FFFFFF; background-color:#0066CC"></font></p>
</form>
<p align="center" style="word-spacing: 0; margin: 0">&nbsp;</p>
<p align="center" style="word-spacing: 0; margin: 0">&nbsp;</p>
<p align="center" style="word-spacing: 0; margin: 0">&nbsp;</p>
...
<p align="center" style="word-spacing: 0; margin: 0">&nbsp;</p>
      ...
      <b>
<p align="justify" style="word-spacing: 0; margin: 0">&nbsp;</p>
<p align="center" style="word-spacing: 0; margin: 0">&nbsp;</p>
<p align="center" style="word-spacing: 0; margin: 0">&nbsp;</p>
      </span>
